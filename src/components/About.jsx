        ...
        >
          <div className="relative">
            ...
            <Image
              ...
              width={300}
              height={300}
              className="relative rounded-full border-4 border-gray-800 shadow-xl object-cover"
            />
          </div>
        </motion.div>
          ...
          <div className="flex flex-wrap gap-3">
            {["React", "Next.js", "Node.js", "Python", "PostgreSQL", "AWS"].map(
              (tech, index) => (
                <span
                  key={index}
                  className="px-4 py-1 text-sm bg-gray-800 rounded-full border border-gray-700 hover:border-blue-500 transition"
                >
                  {tech}
                </span>
              )
